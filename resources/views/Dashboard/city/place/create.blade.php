<x-dashboard.layout title="إضافة مكان">
    @push('style')
      ...
      <div class="row">
          ...
          <div class="col-md-10">
              <div class="box shadow rounded-3 p-2">
                  ...
                  <div class="container-fluid">
                    <form action="{{route('cities.place.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @include('Dashboard.city.place._form',['btn_text'=>'إضافة','city'=>$city,'categories'=>$categories,'place'=>$place])
                    </form>
                  </div>
              </div>
          </div>
