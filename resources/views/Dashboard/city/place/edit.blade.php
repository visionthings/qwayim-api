      ...
      <div class="row">
          ...
          <div class="col-md-10">
              <div class="box shadow rounded-3 p-2">
                  ...
                  <div class="container-fluid">
                    <form action="{{route('cities.place.update',$city->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @include('Dashboard.city.place._form',['btn_text'=>'تعديل','city'=>$city,'categories'=>$categories,'place'=>$place])
                    </form>  
                  </div>
              </div>
          </div>    
